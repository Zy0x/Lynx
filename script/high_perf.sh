...
# Set perf
setprop lynx.mode high
echo " •> High Performance mode activated at $(date "+%H:%M:%S")" >> $LOG

# Report
sed -Ei "s/^description=\[.*\]/description=[ 🔥 Hɪɢʜ Pᴇʀꜰᴏʀᴍᴀɴᴄᴇ Mᴏᴅᴇ ]/" "$BASEDIR/module.prop"
am start -a android.intent.action.MAIN -e toasttext "🔥 Hɪɢʜ Pᴇʀꜰᴏʀᴍᴀɴᴄᴇ Mᴏᴅᴇ" -n bellavita.toast/.MainActivity
